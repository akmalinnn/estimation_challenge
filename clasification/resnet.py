...
class ResNet(nn.Module):
    def __init__(self, n, shortcuts=True):
        ...
        # Input
        # self.convIn = nn.Conv2d(3, 16, kernel_size=3, stride=1, padding=1, bias=False) //ganti channel ke 2
        self.convIn = nn.Conv2d(2, 16, kernel_size=3, stride=1, padding=1, bias=False)
...
if __name__ == '__main__':
    ...
    inputs = torch.rand(4, 2, 1080, 1920)
